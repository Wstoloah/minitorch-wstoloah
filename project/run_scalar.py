...
class Network(minitorch.Module):
    def __init__(self, hidden_layers: int):
        """
        Initializes a 3-layer feedforward neural network.

        Args:
            hidden_layers (int): Number of hidden units in each hidden layer.
        """
        super().__init__()
        input_size = 2  # Assuming 2 input features
        output_size = 1  # Single output unit (binary classification)
